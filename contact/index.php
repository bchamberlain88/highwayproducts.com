...
<div class='container sb'>
    ...
    <div class='left-content'>
      ...
      itemtype="http://schema.org/ListItem"><a class='animate' href='<?php echo DIR_ROOT; ?>' itemprop="item">
        ...
        <a href="<?php echo PHONE_NUMBER_LINK ?>"><img style="width: 100%;" src="<?php echo DIR_IMAGES. '_misc/how_to_buy.png?' . filemtime_remote(DIR_IMAGES. '_misc/how_to_buy.png'); ?>" alt='How to buy' /></a>
    ...
    <div class='right-content'>
        ...
        <ul class='callout-features'>
            ...
            <li class='callout-feature'>
                ...
                <a href="<?php echo PHONE_NUMBER_LINK ?>"><?php echo PHONE_NUMBER ?></a>
            </li>
