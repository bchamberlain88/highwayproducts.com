<?php
//check if url is tied to quote codes
include_once 'quote_url_detection.php';
            ...
            if($rQuoteCodes['use_static_codes'] == 1) { ?>
                <div class='get-quote-wrapper'>
                    <div class='get-quote-content'>
                        ...
                        <div class="AW-Form-<?php echo $form_id ?>" style='left:-99999px;position:absolute;top:-99999px;display:none;'></div>
