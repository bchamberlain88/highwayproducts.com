            ...
            <ul class='footer-list'>
                ...
                <li>
                    <a target="_blank" class="animate" href="http://pavati.com/">
                        <img class="familyBrand" src="<?php echo DIR_IMAGES . '_misc/pavati.png'?>">
                    </a>
                </li>
                <li>
                    <a target="_blank" class="animate" href="http://www.pavatimarine.com/">
                        <img class="familyBrand" src="<?php echo DIR_IMAGES . '_misc/pavatimarine.png'?>">
                    </a>
                </li>
                <li>
                    <a target="_blank" class="animate" href="http://www.800toolbox.com/">
                        <img class="familyBrand" src="<?php echo DIR_IMAGES . '_misc/800toolbox.jpg'?>">
                    </a>
                </li>
            </ul>
            <!-- social media links -->
