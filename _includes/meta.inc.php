...
<?php 
// $getFBpixel = mysql_query("SELECT * FROM fb_pixel WHERE selector = '".$product_selector."'");
// $rGetFBpixel = mysql_fetch_assoc($getFBpixel);
// if(mysql_num_rows($getFBpixel) > 0){
//     echo $rGetFBpixel['pixel_code'];
// }
?>
