...
/**
 * Image engine configuration (internal hub including the common configuration)
 * 
 * @package		squeezr
...
require_once dirname(__DIR__).DIRECTORY_SEPARATOR.'conf'.DIRECTORY_SEPARATOR.'image.php';